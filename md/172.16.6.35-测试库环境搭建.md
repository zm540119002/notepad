...
nohup java -Xdebug -Xrunjdwp:transport=dt_socket,address=428761,server=y,suspend=n -Dspring.profiles.active=test -jar /www/data_govern/jars/databank-eurekaserver.jar >> /www/data_govern/logs/databank-eurekaserver.log 2>&1 &
