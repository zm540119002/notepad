...
CREATE TABLE `address`  (
  ...
  `province` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '省',
  `city` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '市',
  `area` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '区',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `member_id`(`user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 99 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '买家地址信息表' ROW_FORMAT = Compact;
...
INSERT INTO `address` VALUES (95, 55, '11', '11', '', '15914540659', 1, 2, '2', '2', '2');
INSERT INTO `address` VALUES (96, 65, '阿牛111', '18', '', '13522221111', 0, 0, '9', '1', '1');
INSERT INTO `address` VALUES (97, 55, '111', '1111111111', '', '15914540659', 1, 0, '6', '2', '2');
INSERT INTO `address` VALUES (98, 64, '股份刚好', '发傻', '', '18664368697', 0, 0, '1', '1', '0');
...
CREATE TABLE `address_c`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `member_id`(`user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 188 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'vue版买家地址信息表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of address_c
-- ----------------------------
INSERT INTO `address_c` VALUES (184, 65, '阿森纳', '河北省唐山市古冶区河北省唐山市古冶区河北省唐山市古冶区河北省唐山市古冶区河北省唐山市古冶区杭州市西湖区 黄龙万科中心', '', '13679898380', 0, 0, '130000', '130200', '130204');
...
INSERT INTO `address_c` VALUES (187, 65, '曼城', '杭州市西湖区 黄龙万科中心', '', '13288880000', 1, 0, '320000', '320100', '320102');
...
CREATE TABLE `promotion`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '促销活动名称',
  `first_img` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '促销活动图片',
  `second_img` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '促销活动图片',
  ...
  `run_type` tinyint(3) UNSIGNED NOT NULL DEFAULT 0 COMMENT '经营类型 1：采购店铺 2：零售店铺 3：分成店铺',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '促销活动表' ROW_FORMAT = Compact;
...
CREATE TABLE `user`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 93 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (17, '张敏', '', '18819362618', 0, 1, 'ae020c13647d47182e178951c98fa1f3', 1, 'user_avatar/2019081717253663528.jpeg', 0, 'qkLISmHeOG', 0, 1573697292, 1561345595, 0);
INSERT INTO `user` VALUES (48, 'GFrien', '', '13265155634', 0, 1, '757146f34f494332a368f78826c6a7ed', 0, 'user_avatar/2019061210062327981.jpeg', 0, 'YaAelLcKEv', 0, 1566389839, 0, 0);
INSERT INTO `user` VALUES (54, '翁先生', '', '13422826641', 0, 1, '56923613efb916e45dd4140b5bec924d', 1, 'user_avatar/2019060609260964384.png', 0, 'VXukixEAtQ', 0, 1572939438, 1559783169, 1564558618);
INSERT INTO `user` VALUES (55, '11', '', '15914540659', 0, 1, 'ae49547da680549422cc86aafc0dc3b4', 1, 'user_avatar/201906271915388803106695.jpeg', 0, 'zldFiMkHDN', 0, 1568701530, 1559802761, 0);
...
INSERT INTO `user` VALUES (64, '杨观保', '', '18664368697', 0, 1, '7b5619709cb2e214fb241b27c89056ca', 1, 'user_avatar/2019090315311120436.jpeg', 0, 'cPOoJBgaCV', 0, 1573694746, 1561344118, 0);
INSERT INTO `user` VALUES (65, '小朱888', '', '13679898380', 0, 1, '5a3ad5db7b3b7566bbceba72aa8fed4f', 1, 'user_avatar/2019090909244155406.jpeg', 0, 'WrsVDzIgtf', 0, 1573089727, 1561345595, 1565772271);
...
INSERT INTO `user` VALUES (72, '习·俊', '', '13250591333', 0, 1, 'f03eb15b6f6cb408fb108ee06d1d3529', 0, 'user_avatar/201907011305199865250847.jpeg', 0, 'CyqsLTVYxn', 0, 1572185377, 1561957519, 1572185377);
...
INSERT INTO `user` VALUES (85, '', '', '18511397316', 0, 1, 'a446ffbd33ba36a150c17d6a8ea8018a', 0, '', 0, 'EfGDyzbvsM', 0, 1566861787, 1566861462, 1566861787);
INSERT INTO `user` VALUES (86, '博文', '', '13453262032', 0, 1, 'faab914758734cc58f0add68385a044a', 0, 'user_avatar/201909010129011707148428.jpeg', 0, 'EMitmKTFDe', 0, 1567272536, 1567272536, 0);
INSERT INTO `user` VALUES (87, '張君¹⁵⁸⁹⁴⁶⁸⁴¹⁹¹', '', '15894684191', 0, 1, '14345cdac9665104850977eddbadcaf5', 0, 'user_avatar/201909081554362944217509.jpeg', 0, 'enFIsbhcQv', 0, 1567920542, 1567920542, 0);
INSERT INTO `user` VALUES (88, '孙晨皓-绝意行事', '', '13905719109', 0, 1, '8b2416ee122b0e085a1921e8524ee8bf', 0, 'user_avatar/201909261818213686126013.jpeg', 0, 'IQFzqDLapl', 0, 1569493101, 1569493101, 0);
INSERT INTO `user` VALUES (89, '張君¹⁵⁸⁹⁴⁶⁸⁴¹⁹¹', '', '18094876876', 0, 1, '9e24ea07c372d00abd06309d3f663adb', 0, 'user_avatar/201909291622007520473963.jpeg', 0, 'IyzZaRDPGT', 0, 1573267025, 1569745320, 1573267025);
INSERT INTO `user` VALUES (90, '史向伟13199913943', '', '13199913943', 0, 1, '5e4de4054f868393ad5871cef53a5ee1', 0, 'user_avatar/201910082256408123756992.jpeg', 0, 'tLNjkAlFXe', 0, 1570546578, 1570546578, 0);
INSERT INTO `user` VALUES (91, '潘甲明', '', '15398002257', 0, 1, '578c608d79ef9dcfd57cff6d09558823', 0, 'user_avatar/201910291115305287301760.jpeg', 0, 'ftZzjDiGqV', 0, 1572318843, 1572318843, 0);
INSERT INTO `user` VALUES (92, '姚统军 | 知识产权|财税', '', '18520140227', 0, 1, 'bf949fe37aa43cab765dafffa45f0a2a', 0, 'user_avatar/201911041648084359822946.jpeg', 0, 'huOfbkxFGL', 0, 1572857087, 1572857087, 0);
